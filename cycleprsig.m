function [powratioi,powratioalli] = cycleprsig(data,orbit,sr1,sr2,srstep,method_cutoff,cutoff,cutoff_value)
...
for i = sr1:srstep:sr2
    [~,powratio,powratioall] = ratiovalue(data(:,1),data(:,2),orbit,i,method_cutoff,cutoff,cutoff_value);
